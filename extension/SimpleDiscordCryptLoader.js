...
chrome.runtime.sendMessage({ type: 'XMLHttpRequest', request: { url: "https://github.com/SK0lll/SDC/raw/main/SimpleDiscordCrypt.user.js" } }, (result) => { //or chrome.runtime.getURL("SimpleDiscordCrypt.user.js")
	let script = document.createElement('script');
	script.textContent = `
(()=>{
